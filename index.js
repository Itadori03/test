...
const { sck1,userdb } = require(__dirname + '/database/user')
const { bgms } = require(__dirname + '/database/bgm')
const { sck,groupdb } = require(__dirname + '/database/group')
const { alive,alivedb } = require(__dirname + '/database/alive')
const { RandomXP } = require(__dirname + '/database/xp')
const { Pluginsdb,Plugindb } = require(__dirname + '/database/plugins')
...
const { cmd,smd, commands } = require(__dirname + '/commands')
const { chatbot } = require(__dirname+'/database/chatbot')
const { antiViewOnce } = require(__dirname+'/antiViewOnce.js')
const {sendAnimeReaction ,yt, sendGImages ,AudioToBlackVideo, textToLogoGenerator,photoEditor,updateProfilePicture,randomeFunfacts,getRandom,generateSticker,forwardMessage,plugins,audioEditor,send,react,  } = require("./suhail.js")
